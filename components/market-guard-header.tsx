        ...
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <div className="relative">
              <Image src="/ward-ai-logo.png" alt="Ward AI Logo" width={40} height={40} className="h-10 w-10" />
            </div>
            <div>
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link
              href="/dao"
              className={`text-sm hover:text-primary transition-colors ${pathname === "/dao" ? "text-primary font-medium" : ""}`}
            >
              DAO
            </Link>
            <Link
